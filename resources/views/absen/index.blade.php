                ...
                <div class="card card-info">
                    ...
                    <form role="form" action="{{route('absenharian')}}" method="post">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <button type="submit" class="btn btn-flat btn-primary form-control" name="btnIn" >ABSEN MASUK</button>
                                </div>
                                <div class="col-3">
                                    <button type="submit" class="btn btn-flat btn-primary form-control" name="btnOut" >ABSEN KELUAR</button>
                                </div>
                                <div class="col-6">
